 ...
 **/
@Entity
@Table(name = "map_bt_extends_define", schema = "portal")
@IdClass(MapBtExtendsDefinePK.class)
public class MapBtExtendsDefine {
    ...
    public boolean equals(Object o) {
        ...
        MapBtExtendsDefine that = (MapBtExtendsDefine) o;
