 ...
 **/
@Entity
@Table(name = "map_pt_extends_define", schema = "portal")
@IdClass(MapPtExtendsDefinePK.class)
public class MapPtExtendsDefine {
    ...
    public boolean equals(Object o) {
        ...
        MapPtExtendsDefine that = (MapPtExtendsDefine) o;
