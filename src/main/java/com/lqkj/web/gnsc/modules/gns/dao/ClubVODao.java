...
public interface ClubVODao extends JpaRepository<GnsClubVO,Integer> {
    ...
    @Query(nativeQuery = true,
        value = "select g.club_id,club_name,c.campus_code,g.update_time,g.description,g.click from gns.gns_club g left join gns.gns_campus_info c on g.campus_code = c.campus_code where 1=1 " +
