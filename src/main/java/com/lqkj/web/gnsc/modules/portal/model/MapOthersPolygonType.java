 ...
 **/
@Entity
@Table(name = "map_others_polygon_type", schema = "portal")
public class MapOthersPolygonType extends BaseRowModel {
    ...
    public MapOthersPolygonType(){}

    /**
     * 构造函数
     */
    public MapOthersPolygonType(Integer typeCode, Integer parentCode, String typeName, Boolean click,
    ...
    public boolean equals(Object o) {
        ...
        MapOthersPolygonType that = (MapOthersPolygonType) o;
