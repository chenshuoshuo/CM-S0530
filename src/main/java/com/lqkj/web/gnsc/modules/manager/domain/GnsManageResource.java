...
@Entity
@Table(name = "gns_manage_resource",schema = "gns")
public class GnsManageResource implements Serializable, GrantedAuthority {
    ...
    public GnsManageResource() {
    }

    public GnsManageResource(String name, String content) {
        this.name = name;
