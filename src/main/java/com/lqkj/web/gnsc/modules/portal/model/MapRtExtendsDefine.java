 ...
 **/
@Entity
@Table(name = "map_rt_extends_define", schema = "portal")
@IdClass(MapRtExtendsDefinePK.class)
public class MapRtExtendsDefine {
    ...
    public boolean equals(Object o) {
        ...
        MapRtExtendsDefine that = (MapRtExtendsDefine) o;
