...
public class ExcelUtils {
    ...
    public static ResponseEntity<InputStreamResource> downloadOneSheetExcel(Class<? extends BaseRowModel> clazz,
        ...
        FileOutputStream outputStream = new FileOutputStream(FileUtils.getTempDirectoryPath() + "/template.xlsx");
        ...
        writer.finish();
        try {
            return loadFromOutputSteam(outputStream, fileName);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
     ...
     * @throws IOException IO异常
     */
    public static ResponseEntity<InputStreamResource> downloadOneSheetExcelWithHead(Class<? extends BaseRowModel> clazz,
                                                                                          List<? extends BaseRowModel> dataList,
                                                                                          String sheetName, List<List<List<String>>> headList, String fileName)
            throws IOException {
