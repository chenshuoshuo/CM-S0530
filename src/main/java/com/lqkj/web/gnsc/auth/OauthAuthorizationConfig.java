...
public class OauthAuthorizationConfig extends WebSecurityConfigurerAdapter  implements AuthorizationServerConfigurer {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                .withClient("gnsc-h5")
                .scopes("js")
                .resourceIds("gnsc-server")
                .authorizedGrantTypes("password", "refresh_token")
                .secret(NoOpPasswordEncoder.getInstance().encode("gnsc-h5"))
                ...
                .refreshTokenValiditySeconds((int) TimeUnit.DAYS.toSeconds(7))
                .and()
                .withClient("gnsc-guest")
                .scopes("guest")
                .resourceIds("gnsc-server")
                .authorizedGrantTypes("client_credentials")
                .secret(NoOpPasswordEncoder.getInstance().encode("gnsc-guest"))
